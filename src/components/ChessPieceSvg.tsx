    ...
    >
      <defs>
        ...
        <linearGradient id="goldAccentGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#947414" />
        </linearGradient>

        {/* Crisp Drop Shadow Filter */}
        <filter id="pieceShadow" x="-30%" y="-20%" width="160%" height="150%">
      ...
      {/* 1. NEO-GRANDMASTER / HIGH-GRAPHIC TOURNAMENT STYLE (MATCHING SCREENSHOT) */}
      {(style === 'neo-grandmaster' || style === '3d-metallic') && (
        <g filter="url(#pieceShadow)">
          {/* Pawn */}
          {pType === 'p' && (
            <g
              fill={isWhite ? 'url(#whitePieceGrad)' : 'url(#blackPieceGrad)'}
              stroke={isWhite ? '#3A3229' : '#141211'}
              strokeWidth="1.3"
              strokeLinecap="round"
              strokeLinejoin="round"
            >
              <path d="M 22.5,9 C 20,9 18,11 18,13.5 C 18,14.2 18.2,14.8 18.5,15.4 C 16.3,16.5 14.8,18.8 14.8,21.4 C 14.8,23.1 15.4,24.7 16.4,26 C 14.5,27.1 13,29.1 12.8,31.5 L 32.2,31.5 C 32,29.1 30.5,27.1 28.6,26 C 29.6,24.7 30.2,23.1 30.2,21.4 C 30.2,18.8 28.7,16.5 26.5,15.4 C 26.8,14.8 27,14.2 27,13.5 C 27,11 25,9 22.5,9 z" />
              <path d="M 12,33.5 L 33,33.5" stroke={isWhite ? '#3A3229' : '#141211'} strokeWidth="1.2" />
              <path d="M 11.5,36 L 33.5,36" stroke={isWhite ? '#3A3229' : '#141211'} strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" stroke={isWhite ? '#3A3229' : '#141211'} strokeWidth="1.4" />
            </g>
          )}
          ...
          {pType === 'n' && (
            <g
              ...
              strokeLinejoin="round"
            >
              <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.84 6.84,29.81 6,28 C 6,26 7.23,24.5 10,24 C 12.77,23.5 17.5,23.5 20,21 C 21.17,19.83 22,10 22,10 z" />
              <path d="M 11.5,36 L 33.5,36" stroke={isWhite ? '#3A3229' : '#141211'} strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" stroke={isWhite ? '#3A3229' : '#141211'} strokeWidth="1.4" />
              <circle cx="11.5" cy="26" r="1" fill={isWhite ? '#3A3229' : '#FAF7F0'} stroke="none" />
            </g>
          )}
          ...
          {pType === 'b' && (
            ...
            >
              ...
              <path d="M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,28 29,26 C 27.5,23 23,20 22.5,13.5 C 22,20 17.5,23 16,26 C 15,28 14.5,30.5 15,32 z" />
              <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30" />
              <path d="M 11.5,36 L 33.5,36" strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" strokeWidth="1.4" />
            </g>
          )}
          ...
          {pType === 'r' && (
            <g
              ...
              strokeLinejoin="round"
            >
              <path d="M 11,13 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,13 L 11,13 z" />
              <path d="M 12,13 L 33,13 L 31,32 L 14,32 L 12,13 z" />
              <path d="M 11.5,36 L 33.5,36" strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" strokeWidth="1.4" />
            </g>
          )}
          ...
          {pType === 'q' && (
            ...
            >
              ...
              <path d="M 9,26 C 9,28 10.5,28 11.5,30 L 33.5,30 C 34.5,28 36,28 36,26" />
              <path d="M 11.5,36 L 33.5,36" strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" strokeWidth="1.4" />
            </g>
          )}
          ...
          {pType === 'k' && (
            <g
              ...
              strokeLinejoin="round"
            >
              {/* Grandmaster King Cross */}
              <path d="M 22.5,11.5 L 22.5,5" strokeWidth="2.2" />
              <path d="M 19.5,8 L 25.5,8" strokeWidth="2.2" />
              ...
              <path d="M 11.5,30 C 17,27 28,27 33.5,30 L 33.5,36 L 11.5,36 Z" />
              <path d="M 11.5,36 L 33.5,36" strokeWidth="1.2" />
              <path d="M 11,38.5 L 34,38.5" strokeWidth="1.4" />
            </g>
          )}
