    ...
    >
      ...
      {key === 'wn' && (
        <g fill="none" fillRule="evenodd" stroke="#121411" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" fill="#FAF9F6" />
          <path d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.84 6.84,29.81 6,28 C 6,26 7.23,24.5 10,24 C 12.77,23.5 17.5,23.5 20,21 C 21.17,19.83 22,10 22,10 C 22,10 18,11 14,15 C 9.922,19.08 8,24.5 8,30 C 8,33 9.5,38.5 12,39 L 15,39" fill="#FAF9F6" />
          <path d="M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 Z" fill="#121411" stroke="#121411" />
          <path d="M 15 15.5 C 15 15.5 17.5 17.5 19 17.5 C 20.5 17.5 23 15.5 23 15.5" stroke="#121411" />
        </g>
      )}
      ...
      {key === 'bn' && (
        <g fill="none" fillRule="evenodd" stroke="#FAF9F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M 15 15.5 C 15 15.5 17.5 17.5 19 17.5 C 20.5 17.5 23 15.5 23 15.5" stroke="#FAF9F6" />
        </g>
      )}
